  ...
  return (
    <div>
        <div className='w-full overflow-x-hidden'>           
            <div className={`flex py-7 justify-between px-85 items-center text-white sticky top-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-gray-600/80 backdrop-blur-md' : 'bg-gray-600'}`}>
